...
import net.sf.repairslab.control.PrintAction;
...
public class VcIfrListaSchede extends JInternalFrame {
	...
	private JButton getBtnView() {
		if (btnView == null) {
			...
			btnView.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/view_remove.png"))); //$NON-NLS-1$
	...
	private JButton getBtnEdit() {
		if (btnEdit == null) {
			...
			btnEdit.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/edit.png"))); //$NON-NLS-1$
...
//						reserFilter();
	...
	private JButton getBtnNew() {
		if (btnNew == null) {
			...
			btnNew.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/insert_table_row.png"))); //$NON-NLS-1$
	...
	private JButton getBtnDelete() {
		if (btnDelete == null) {
			...
			btnDelete.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/delete_table_row.png"))); //$NON-NLS-1$
	...
	private JButton getBtnFind() {
		if (btnFind == null) {
			...
			btnFind.setIcon(new ImageIcon(getClass().getResource( "/net/sf/repairslab/ui/img/button_ok.png"))); //$NON-NLS-1$
	...
	private JButton getBtnReset() {
		if (btnReset == null) {
			...
			btnReset.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/button_cancel.png"))); //$NON-NLS-1$
	...
	private JButton getBtnPrint() {
		if (btnPrint == null) {
			...
			btnPrint.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/fileprint.png"))); //$NON-NLS-1$
