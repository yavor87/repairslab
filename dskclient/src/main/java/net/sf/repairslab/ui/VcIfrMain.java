...
public class VcIfrMain extends JInternalFrame implements ActionListener {
	...
	private JButton getBtnInsScheda() {
		if (btnInsScheda == null) {
			...
			btnInsScheda.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/newtodo.png"))); //$NON-NLS-1$
	...
	private JButton getBtnListaSchede() {
		if (btnListaSchede == null) {
			...
			btnListaSchede.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/view_detailed.png"))); //$NON-NLS-1$
	...
	private JButton getBtnViewScheda() {
		if (btnViewScheda == null) {
			...
			btnViewScheda.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/fileopen.png"))); //$NON-NLS-1$
	...
	private JButton getBtnModScheda() {
		if (btnModScheda == null) {
			...
			btnModScheda.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/kate.png"))); //$NON-NLS-1$
	...
	private JButton getBrnStampaScheda() {
		if (brnStampaScheda == null) {
			...
			brnStampaScheda.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/fileprint_.png"))); //$NON-NLS-1$
