...
public class VcIfrDeletedSchede extends JInternalFrame {
	...
	private JButton getBtnRipristina() {
		if (btnRipristina == null) {
			...
			btnRipristina.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/undo.png"))); //$NON-NLS-1$
	...
	private JButton getBtnSvuota() {
		if (btnSvuota == null) {
			...
			btnSvuota.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/trashcan_empty.png"))); //$NON-NLS-1$
