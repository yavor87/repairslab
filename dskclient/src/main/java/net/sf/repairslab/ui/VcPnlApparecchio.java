...
public class VcPnlApparecchio extends JPanel {
	...
	private JButton getBtnAddModello() {
		if (btnAddModello == null) {
			...
			btnAddModello.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/edit_add.png"))); //$NON-NLS-1$
	...
	private JButton getBtnDelDataDA() {
		if (btnDelDataDA == null) {
			...
			btnDelDataDA.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/edit_remove.png"))); //$NON-NLS-1$
			if(modality==mode.view){
