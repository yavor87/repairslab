...
public class VcDlgDetailScheda extends JDialog {
	...
	private JButton getBtnNext() {
		if (btnNext == null) {
			...
			btnNext.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/forward.png"))); //$NON-NLS-1$
	...
	private JButton getBtnSalva() {
		if (btnSalva == null) {
			...
			btnSalva.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/filesave.png"))); //$NON-NLS-1$
			if(modality == mode.view){
	...
	private JButton getBtnPrev() {
		if (btnPrev == null) {
			...
			btnPrev.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/back.png"))); //$NON-NLS-1$
