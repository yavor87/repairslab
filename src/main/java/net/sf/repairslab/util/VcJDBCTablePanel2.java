...
public class VcJDBCTablePanel2 extends JPanel {
	
	static private Logger  logger = Logger.getLogger(VcJDBCTablePanel2.class.getName());
	 ...
	 */
	public VcJDBCTablePanel2(Connection con,String query) {
		super();
		this.con = con;
		this.query = query;
	...
	public void setColumnLabel(int column,String value){
		try{
			...
			logger.debug("Non valid column header...", e);
		}
	}
	...
	private JButton getBtnPageUp() {
		if (btnPageUp == null) {
			...
			btnPageUp.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/2leftarrow.png")));
	...
	private JButton getBtnRecUp() {
		if (btnRecUp == null) {
			...
			btnRecUp.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/previous.png")));
	...
	private JButton getBtnRecDown() {
		if (btnRecDown == null) {
			...
			btnRecDown.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/next.png")));
	...
	private JButton getBtnPageDown() {
		if (btnPageDown == null) {
			...
			btnPageDown.setIcon(new ImageIcon(getClass().getResource(
				"/net/sf/repairslab/ui/img/2rightarrow.png")));
	...
	private JButton getBtnRefresh() {
		if (btnRefresh == null) {
			...
			btnRefresh.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/rebuild.png")));
	...
	private JButton getBtnEdit() {
		if (btnEdit == null) {
			...
			btnEdit.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/edit.png")));
	...
	private JButton getBtnOk() {
		if (btnOk == null) {
			...
			btnOk.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/filesave.png")));
	...
	private JButton getBtnDelete() {
		if (btnDelete == null) {
			...
			btnDelete.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/delete_table_row.png")));
	...
	private JButton getBtnRollback() {
		if (btnRollback == null) {
			...
			btnRollback.setIcon(new ImageIcon(getClass().getResource("/net/sf/repairslab/ui/img/undo.png")));
